...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.profile) {
            ...
            final MediaPlayer mp =MediaPlayer.create(this, R.raw.inflicted);
            mp.start();

                fragment = new ToolsFragment();

        } else if (id == R.id.settings) {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sehaj23")); //put url you want to re-direct
            startActivity(i);
